export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	aron: {
		...
		abilities: {0: "Sturdy", 1: "Rock Head", H: "Rocky Payload"},
		heightm: 0.4,
		weightkg: 60,
		color: "Gray",
		evos: ["Lairon"],
	...
	vanilluxe: {
		...
		name: "Vanilluxe",
		types: ["Ice", "Normal"],
		baseStats: {hp: 81, atk: 95, def: 85, spa: 110, spd: 95, spe: 79},
		abilities: {0: "Ice Body", 1: "Snow Warning", H: "Weak Armor"},
		heightm: 1.3,
		weightkg: 57.5,
		color: "White",
	...
	sawsbuck: {
		...
		baseForme: "Spring",
		types: ["Normal", "Grass"],
		baseStats: {hp: 80, atk: 115, def: 70, spa: 60, spd: 70, spe: 95},
		abilities: {0: "Chlorophyll", 1: "Grass Pelt", H: "Serene Grace"},
		heightm: 1.9,
		weightkg: 92.5,
		color: "Brown",
	...
	amoonguss: {
		...
		name: "Amoonguss",
		types: ["Grass", "Poison"],
		baseStats: {hp: 84, atk: 85, def: 70, spa: 85, spd: 80, spe: 30},
		abilities: {0: "Effect Spore", 1: "Imposter", H: "Regenerator"},
		heightm: 0.6,
		weightkg: 10.5,
		color: "White",
