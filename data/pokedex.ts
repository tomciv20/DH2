export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	voltorb: {
		...
		types: ["Electric", "Steel"],
		gender: "N",
		baseStats: {hp: 30, atk: 70, def: 30, spa: 70, spd: 30, spe: 100},
		abilities: {0: "Transistor", 1: "Battery", H: "Aftermath"},
		heightm: 0.5,
		weightkg: 10.4,
		color: "Red",
		evos: ["Electrode"],
	...
	electrode: {
		...
		types: ["Electric", "Steel"],
		gender: "N",
		baseStats: {hp: 50, atk: 100, def: 50, spa: 100, spd: 50, spe: 150},
		abilities: {0: "Transistor", 1: "Battery", H: "Aftermath"},
		heightm: 1.2,
		weightkg: 66.6,
		color: "Red",
	...
	cubone: {
		...
		name: "Cubone",
		types: ["Ground", "Ghost"],
		baseStats: {hp: 50, atk: 80, def: 55, spa: 25, spd: 60, spe: 60},
		abilities: {0: "Klutz"},
		heightm: 0.4,
		weightkg: 6.5,
		color: "Brown",
	...
	rhyhorn: {
		...
		abilities: {0: "Lightning Rod", 1: "Rock Head", H: "Solid Rock"},
		heightm: 1,
		weightkg: 115,
		color: "Gray",
		evos: ["Rhydon"],
